...
const tag = ''   
const kadınrol = message.guild.roles.cache.find(r => r.id === '') //kadın rol id
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '')//kadın rol2 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '')//kayıtsız rol id
const genelchat = message.guild.channels.cache.find(c => c.id === '')//genel chat id
const savelog = message.guild.channels.cache.find(c => c.id === '')//savelog id
